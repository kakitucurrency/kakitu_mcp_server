...
var kshs_address_1 = __importDefault(require("./lib/nano-address"));
var kshs_converter_1 = __importDefault(require("./lib/nano-converter"));
...
var wallet = {
     ...
     * The address is prefixed with 'kshs_'.
     *
...
var block = {
    ...
    representative: function (data, privateKey) {
        var block = __assign(__assign({}, data), { fromAddress: data.address, amountRaw: '0', toAddress: 'kshs_1111111111111111111111111111111111111111111111111111hifc8npp' });
...
var tools = {
    ...
    convert: function (input, inputUnit, outputUnit) {
        return kshs_converter_1.default.convert(input, inputUnit, outputUnit);
    },
    /**
    ...
    verifyBlock: function (publicKey, block) {
        ...
        return signer_1.default.verify(publicKey, block.signature, preamble, kshs_address_1.default.nanoAddressToHexString(block.account), block.previous, kshs_address_1.default.nanoAddressToHexString(block.representative), convert_1.default.dec2hex(block.balance, 16).toUpperCase(), block.link);
    },
    /**
    ...
    validateAddress: function (input) {
        return kshs_address_1.default.validateNanoAddress(input);
    },
    /**
    ...
    addressToPublicKey: function (input) {
        return kshs_address_1.default.addressToPublicKey(input);
    },
    /**
    ...
    publicKeyToAddress: function (input) {
        return kshs_address_1.default.deriveAddress(input);
    },
    /**
