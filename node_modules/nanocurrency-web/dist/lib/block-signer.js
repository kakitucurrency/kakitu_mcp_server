...
var kshs_address_1 = __importDefault(require("./nano-address"));
var kshs_converter_1 = __importDefault(require("./nano-converter"));
...
var BlockSigner = /** @class */ (function () {
    ...
    BlockSigner.receive = function (data, privateKey) {
        ...
        if (!kshs_address_1.default.validateNanoAddress(data.toAddress)) {
            throw new Error('Invalid toAddress');
        }
        if (!kshs_address_1.default.validateNanoAddress(data.representativeAddress)) {
        ...
        var balanceNano = kshs_converter_1.default.convert(data.walletBalanceRaw, 'RAW', 'NANO');
        var amountNano = kshs_converter_1.default.convert(data.amountRaw, 'RAW', 'NANO');
        var newBalanceNano = new bignumber_js_1.default(balanceNano).plus(new bignumber_js_1.default(amountNano));
        var newBalanceRaw = kshs_converter_1.default.convert(newBalanceNano, 'NANO', 'RAW');
        var newBalanceHex = convert_1.default.dec2hex(newBalanceRaw, 16).toUpperCase();
        var account = kshs_address_1.default.nanoAddressToHexString(data.toAddress);
        var link = data.transactionHash;
        var representative = kshs_address_1.default.nanoAddressToHexString(data.representativeAddress);
    ...
    BlockSigner.send = function (data, privateKey) {
        ...
        if (!kshs_address_1.default.validateNanoAddress(data.fromAddress)) {
        ...
        var newBalanceRaw = kshs_converter_1.default.convert(newBalanceNano, 'NANO', 'RAW');
        var newBalanceHex = convert_1.default.dec2hex(newBalanceRaw, 16).toUpperCase();
        var account = kshs_address_1.default.nanoAddressToHexString(data.fromAddress);
        var link = kshs_address_1.default.nanoAddressToHexString(data.toAddress);
        var representative = kshs_address_1.default.nanoAddressToHexString(data.representativeAddress);
        var signature = signer_1.default.sign(privateKey, _a.preamble, account, data.frontier, representative, newBalanceHex, link);
        return {
            type: 'state',
